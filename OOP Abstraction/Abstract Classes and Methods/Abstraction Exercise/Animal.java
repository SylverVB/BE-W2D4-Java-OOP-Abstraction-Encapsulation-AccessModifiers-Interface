...
public abstract class Animal {
	...
	/*
	 * As was mentioned, abstract classes can have concrete methods (methods with implementation). However, subclasses can still override these concrete methods with their own implementation if desired.
	 */
	public void exist() {
